...
set_defvar -name {TEMPR}   -value {MIL}
set_defvar -name {PART_RANGE}   -value {MIL}
...
set_defvar -name {PA4_GB_COUNT} -value {34}
...
set_compile_info \
    ...
    -name {"Topcell"} \
    -value {"RTG4_CoreRISCV_AXI4_BaseDesign"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Format"} \
    -value {"EDIF"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\cyril.jean\Documents\GitHub\Cyril-Jean\RTG4-Development-Kit\Libero\RTG4_CoreRISCV_AXI4_BaseDesign\synthesis\RTG4_CoreRISCV_AXI4_BaseDesign.edn"}
set_compile_info \
    -category {"Options"} \
