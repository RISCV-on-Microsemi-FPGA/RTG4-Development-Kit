...
# Exporting Create design command for core MIV_RV32IMC_CFG2
create_and_configure_core -core_vlnv {Microsemi:MiV:MIV_RV32IMC:2.1.100} -component_name {MIV_RV32IMC_CFG2} -params {\
