...
set Libero_project_name_CFG1 RTG4_Dev_Kit_MiV_RV32IMC_CFG1_BaseDesign

set project_folder_name_CFG2 MiV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 RTG4_Dev_Kit_MiV_RV32IMC_CFG2_BaseDesign

set project_folder_name_CFG3 MiV_CFG3_BD
set project_dir_CFG3 "./$project_folder_name_CFG3"
set Libero_project_name_CFG3 RTG4_Dev_Kit_MiV_RV32IMC_CFG3_BaseDesign
...
configure_tool -name {SYNTHESIZE} -params {BLOCK_MODE:false} -params {BLOCK_PLACEMENT_CONFLICTS:ERROR} -params {BLOCK_ROUTING_CONFLICTS:LOCK} -params {CLOCK_ASYNC:150} -params {CLOCK_DATA:5000} -params {CLOCK_GLOBAL:2} -params {PA4_GB_COUNT:16} -params {PA4_GB_MAX_RCLKINT_INSERTION:16} -params {PA4_GB_MIN_GB_FANOUT_TO_USE_RCLKINT:300} -params {RAM_OPTIMIZED_FOR_POWER:0} -params {RETIMING:true} -params {SYNPLIFY_OPTIONS:} -params {SYNPLIFY_TCL_FILE:}
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {RTG4_Dev_Kit_MiV_RV32IMC_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {RTG4_Dev_Kit_MiV_RV32IMC_CFG2_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {RTG4_Dev_Kit_MiV_RV32IMC_CFG3_BaseDesign} \
